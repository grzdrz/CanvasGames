...
/***/ "./src/game/Game_1/SessionView.ts":
/*!****************************************!*\
  !*** ./src/game/Game_1/SessionView.ts ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _ViewSystem_View__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ViewSystem/View */ \"./src/game/ViewSystem/View.ts\");\n/* harmony import */ var _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/Vector */ \"./src/game/Helpers/Vector.ts\");\n/* harmony import */ var _Collisions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Collisions */ \"./src/game/Game_1/Collisions.ts\");\n/* harmony import */ var _Helpers_MathFunctions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Helpers/MathFunctions */ \"./src/game/Helpers/MathFunctions.ts\");\n/* harmony import */ var _GameObjects_Player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./GameObjects/Player */ \"./src/game/Game_1/GameObjects/Player.ts\");\n/* harmony import */ var _GameObjects_Enemy__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./GameObjects/Enemy */ \"./src/game/Game_1/GameObjects/Enemy.ts\");\n/* harmony import */ var _States_GameState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../States/GameState */ \"./src/game/States/GameState.ts\");\n/* harmony import */ var _Data_ViewState__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Data/ViewState */ \"./src/game/Data/ViewState.ts\");\n/* harmony import */ var _ViewSystem_ViewEntry__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../ViewSystem/ViewEntry */ \"./src/game/ViewSystem/ViewEntry.ts\");\n/* harmony import */ var _States_EntryType__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../States/EntryType */ \"./src/game/States/EntryType.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass SessionView extends _ViewSystem_View__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n    constructor(viewManager) {\r\n        super(viewManager);\r\n        this.gameState = _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Active;\r\n        this.gameObjects = new Array();\r\n        this.spawnTimeStamp = 0;\r\n        this.handleKeyClick = (args) => {\r\n            if (this.viewState === _Data_ViewState__WEBPACK_IMPORTED_MODULE_7__[\"default\"].Hidden)\r\n                return;\r\n            if (args.data.key === \"Escape\") {\r\n                switch (this.gameState) {\r\n                    case _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Win: {\r\n                        this.viewManager.removeView(this);\r\n                        break;\r\n                    }\r\n                    case _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Lose: {\r\n                        this.viewManager.removeView(this);\r\n                        break;\r\n                    }\r\n                    case _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Pause: {\r\n                        this.gameState = _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Active;\r\n                        break;\r\n                    }\r\n                    case _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Active: {\r\n                        this.gameState = _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Pause;\r\n                        break;\r\n                    }\r\n                }\r\n            }\r\n        };\r\n        this.handleMouseClick = (eventArgs) => {\r\n            if (this.viewState === _Data_ViewState__WEBPACK_IMPORTED_MODULE_7__[\"default\"].Hidden)\r\n                return;\r\n            if (this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Pause || this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Win || this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Lose) {\r\n                const hoverIndex = this.getMenuEntryAt(eventArgs.data.mousePosition);\r\n                if (hoverIndex > -1 && this.menuEntries[hoverIndex].isSelectable())\r\n                    this.selectedEntry = hoverIndex;\r\n                else\r\n                    this.selectedEntry = -1;\r\n                if (this.selectedEntry != -1) {\r\n                    if (this.menuEntries[this.selectedEntry].isExitItem()) {\r\n                        this.exitView();\r\n                    }\r\n                    else if (this.menuEntries[this.selectedEntry].type === _States_EntryType__WEBPACK_IMPORTED_MODULE_9__[\"default\"].Restart) {\r\n                        this.unloadContent();\r\n                        this.loadContent();\r\n                    }\r\n                }\r\n            }\r\n        };\r\n        this.player = new _GameObjects_Player__WEBPACK_IMPORTED_MODULE_4__[\"default\"]({\r\n            size: new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](40, 40),\r\n            position: new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](50, 50),\r\n            color: \"green\",\r\n            mass: 1,\r\n            restitution: 0.9,\r\n        }, this);\r\n    }\r\n    initialize() {\r\n        this.gameObjects = new Array();\r\n        this.player = new _GameObjects_Player__WEBPACK_IMPORTED_MODULE_4__[\"default\"]({\r\n            size: new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](40, 40),\r\n            position: new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](50, 50),\r\n            color: \"green\",\r\n            mass: 1,\r\n            restitution: 0.9,\r\n        }, this);\r\n        this.gameObjects.push(this.player);\r\n        this.addMenuItem(_States_EntryType__WEBPACK_IMPORTED_MODULE_9__[\"default\"].ExitItem, new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](50, 50), new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](150, 150));\r\n        this.addMenuItem(_States_EntryType__WEBPACK_IMPORTED_MODULE_9__[\"default\"].Restart, new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](50, 250), new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](150, 150));\r\n        this.gameState = _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Active;\r\n    }\r\n    loadContent() {\r\n        super.loadContent();\r\n        this.initialize();\r\n        this.viewManager.onKeyUp.subscribe(this.handleKeyClick);\r\n        this.viewManager.onMouseClick.subscribe(this.handleMouseClick);\r\n        this.viewManager.onMouseDown.subscribe(this.player.handlerSetPosition);\r\n        this.viewManager.onMouseMove.subscribe(this.player.handlerSetPosition);\r\n        this.viewManager.onMouseUp.subscribe(this.player.handlerUnhand);\r\n        this.viewManager.onKeyDown.subscribe(this.player.handlerKeyDown);\r\n        this.viewManager.onKeyUp.subscribe(this.player.handlerKeyUp);\r\n        this.viewManager.onMouseClick.subscribe(this.player.handleClick);\r\n    }\r\n    unloadContent() {\r\n        super.unloadContent();\r\n        this.viewManager.onKeyUp.unsubscribe(this.handleKeyClick);\r\n        this.viewManager.onMouseClick.unsubscribe(this.handleMouseClick);\r\n        this.viewManager.onMouseDown.unsubscribe(this.player.handlerSetPosition);\r\n        this.viewManager.onMouseMove.unsubscribe(this.player.handlerSetPosition);\r\n        this.viewManager.onMouseUp.unsubscribe(this.player.handlerUnhand);\r\n        this.viewManager.onKeyDown.unsubscribe(this.player.handlerKeyDown);\r\n        this.viewManager.onKeyUp.unsubscribe(this.player.handlerKeyUp);\r\n        this.viewManager.onMouseClick.unsubscribe(this.player.handleClick);\r\n    }\r\n    addMenuItem(type, position, size, view) {\r\n        let src = \"\";\r\n        if (type === _States_EntryType__WEBPACK_IMPORTED_MODULE_9__[\"default\"].ExitItem) {\r\n            src = `./src/game/Images/Interface/buttonBack.png`;\r\n        }\r\n        else if (type === _States_EntryType__WEBPACK_IMPORTED_MODULE_9__[\"default\"].Restart) {\r\n            src = `./src/game/Images/Interface/buttonRestart.png`;\r\n        }\r\n        let entry = new _ViewSystem_ViewEntry__WEBPACK_IMPORTED_MODULE_8__[\"default\"](this, type, src, view);\r\n        entry.position = position;\r\n        entry.size = size;\r\n        this.menuEntries.push(entry);\r\n    }\r\n    update(gameTime) {\r\n        if (this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Lose || this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Win || this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Pause) {\r\n            return;\r\n        }\r\n        this.spawnTimeStamp += gameTime;\r\n        if (this.spawnTimeStamp > 0.5) {\r\n            this.spawnTimeStamp = 0;\r\n            this.spawnEnemy();\r\n        }\r\n        this.gameObjects.forEach((obj) => obj.update(gameTime));\r\n        _Collisions__WEBPACK_IMPORTED_MODULE_2__[\"default\"].analyzeCollizions(this.gameObjects, this.viewManager.canvasManager.width, this.viewManager.canvasManager.height);\r\n        if (this.player.position.y < 0)\r\n            this.gameState = _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Win;\r\n        if (this.player.HP <= 0)\r\n            this.gameState = _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Lose;\r\n    }\r\n    draw() {\r\n        this.gameObjects.forEach(obj => {\r\n            obj.draw();\r\n        });\r\n        this.player.draw();\r\n        if (this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Lose) {\r\n            this.viewManager.canvasManager.drawEndGame(false);\r\n            this.viewManager.canvasManager.drawPause();\r\n        }\r\n        else if (this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Win) {\r\n            this.viewManager.canvasManager.drawEndGame(true);\r\n            this.viewManager.canvasManager.drawPause();\r\n        }\r\n        else if (this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Pause) {\r\n            this.viewManager.canvasManager.drawPause();\r\n        }\r\n        if (this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Lose || this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Win || this.gameState === _States_GameState__WEBPACK_IMPORTED_MODULE_6__[\"default\"].Pause) {\r\n            for (let i = 0; i < this.menuEntries.length; ++i) {\r\n                this.menuEntries[i].draw();\r\n            }\r\n        }\r\n    }\r\n    spawnEnemy() {\r\n        const options = {\r\n            position: new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](0, 0),\r\n            velocity: new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](0, 0),\r\n            mass: 1,\r\n            width: 50,\r\n        };\r\n        const positionX = _Helpers_MathFunctions__WEBPACK_IMPORTED_MODULE_3__[\"default\"].randomInteger(0, this.viewManager.canvasManager.width);\r\n        const positionY = options.width / 2;\r\n        options.position = new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](positionX, positionY);\r\n        const velocityX = _Helpers_MathFunctions__WEBPACK_IMPORTED_MODULE_3__[\"default\"].randomInteger(-20, 20) / 1;\r\n        const velocityY = _Helpers_MathFunctions__WEBPACK_IMPORTED_MODULE_3__[\"default\"].randomInteger(-20, 20) / 1;\r\n        options.velocity = new _Helpers_Vector__WEBPACK_IMPORTED_MODULE_1__[\"default\"](velocityX, velocityY);\r\n        this.gameObjects.push(new _GameObjects_Enemy__WEBPACK_IMPORTED_MODULE_5__[\"default\"](options, this));\r\n    }\r\n}\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (SessionView);\r\n\n\n//# sourceURL=webpack:///./src/game/Game_1/SessionView.ts?");
